...
const ProfilePage = () => {
    ...
    const loadProfile = async () => {
      try {
        ...
        if (data.profile) {
          ...
          // Sync avatar URL with AuthContext so TopBar shows correct image
  ...
  const handleAvatarSave = async (croppedImageData) => {
    ...
    try {
      ...
      // Sync with AuthContext so TopBar shows updated avatar
      updateUser({
        ...user,
        profile: {
          ...user?.profile,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.user) {
        // Preserve profile data when updating user context
        updateUser({
          ...response.user,
          profile: {
            ...user?.profile,
  ...
  return (
    <main className="flex-1 overflow-auto relative z-10">
      ...
      >
        <div
          style={{
            ...
            left: "-300px",
            background:
              "radial-gradient(ellipse, rgba(34,197,94,0.055) 0%, transparent 65%)",
            borderRadius: "50%",
          }}
        />
        <div
          style={{
            ...
            right: "-150px",
            background:
              "radial-gradient(ellipse, rgba(109,40,217,0.04) 0%, transparent 65%)",
            borderRadius: "50%",
          }}
        />
        {/* Subtle grid texture */}
      ...
      <div
        className="relative px-6 py-12 md:px-12 lg:px-20 max-w-[1440px] mx-auto space-y-6"
        style={{ zIndex: 1 }}
      >
        {/* ── Page Header ─────────────────────────────────────── */}
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="relative group mb-6">
                  ...
                  <div className="relative w-32 h-32 rounded-full overflow-hidden ring-4 ring-[#1e2233]">
                    <img
                      src={
                        profile.avatar_url ||
                ...
                <h2 className="font-display text-xl font-bold text-slate-100 tracking-tight mb-1">
            ...
            {success && (
              ...
              >
                ...
                <p className="font-medium text-sm">
                  Synchronized: Your profile updates have been successfully
