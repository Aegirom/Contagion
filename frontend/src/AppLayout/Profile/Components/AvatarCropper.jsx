...
const AvatarCropper = ({ initialImage, onSave, onClose }) => {
  ...
  const handleSave = async () => {
   ...
   const backdropClass = "fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-300";
    ...
    return (
      <div className={backdropClass}>
        <div className={modalClass} style={modalContentStyle}>
          <div className="p-6">
               <h3
                 className="font-display text-xl font-bold text-gray-900 mb-2 pb-4 border-b border-phantom"
               >
                 Update Biometrics
               </h3>
               <p
                 className="font-mono text-xs text-gray-600 mb-6"
               ...
               {isLoading ? (
                 <div className="flex flex-col items-center justify-center py-12">
                   ...
                   <p className="font-mono text-xs text-gray-600 uppercase tracking-widest">Processing scan...</p>
              </div>
            ) : (
                ...
                />
                 ...
                 >
                  ...
                  >
                   ...
                   <p className="font-mono text-[10px] text-gray-600 uppercase tracking-widest">or drag and drop here</p>
                </label>
              </div>
            )}
            ...
            {error && (
              <div className="mt-4 p-3 rounded-lg flex items-center gap-3" style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)' }}>
                <svg className="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 ...
                 <p className="font-mono text-xs text-red-500" style={{ fontFamily: 'monospace' }}>{error}</p>
              </div>
            )}
            ...
            <div className="mt-6 flex justify-end">
               <button
                 onClick={onClose}
                 className="px-5 py-2.5 rounded-lg font-mono text-xs uppercase tracking-wider transition-colors text-gray-600 hover:text-gray-800"
               >
                 Cancel
               </button>
            </div>
  ...
  return (
    <div className={backdropClass}>
      <div className={modalClass} style={modalContentStyle}>
        <div className="p-6">
           <h3
             className="font-display text-xl font-bold text-gray-900 mb-6 pb-4 border-b border-phantom"
           >
             Confirm Crop
           </h3>

           <div
             className="relative aspect-square mb-6 rounded-lg overflow-hidden flex items-center justify-center border border-gray-200 bg-gray-50"
           >
             <img
               ref={imageRef}
               src={image}
             ...
             <div className="absolute inset-0 border-[40px] border-white/70 pointer-events-none">
               <div className="w-full h-full rounded-full border-2 border-toxic/50"></div>
             </div>
           </div>

           <div
             className="flex items-center gap-4 p-4 rounded-lg mb-6 bg-gray-50 border border-gray-200"
           >
             <div
               className="w-12 h-12 rounded-full overflow-hidden border-2 border-toxic"
             >
               <div
             ...
             <div>
               <p className="font-display font-bold text-gray-900">Biometric Preview</p>
               <p className="font-mono text-[10px] text-gray-600 uppercase tracking-widest">Circular Output</p>
             </div>
           </div>
