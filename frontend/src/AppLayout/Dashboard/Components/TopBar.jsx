    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.borderColor = "rgba(30,34,51,0.7)";
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            >
              ...
              <span
                style={{ display: user?.profile?.avatar_url ? "none" : "flex" }}
              >
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p
                    className="font-code text-xs mt-0.5"
                    style={{ color: "#475569" }}
                  >
                    {user?.email || "analyst@contagion.sec"}
                  </p>
