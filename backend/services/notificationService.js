...
export const createNotification = async ({ userId, type, message, actorUsername, relatedSubmissionId, relatedCommentId, relatedReviewId }) => {
  try {
    ...
    request.input("relatedSubmissionId", sql.Int, relatedSubmissionId ? Number(relatedSubmissionId) : null);

    fields.push("user_id", "type", "message", "actor_username", "related_submission_id");
